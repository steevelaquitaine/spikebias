"""pipeline for data processing silico horvath probe at depth 3 experiment

usage: 
    sbatch cluster/processing/process_silico_horvath_3.sbatch
...
def cast_as_RecordingExtractor():
    ...
    # cast (30 secs)
    RecordingExtr = recording.run(data_conf, gain=GAIN, offset=True, noise_std=NOISE_STD)
