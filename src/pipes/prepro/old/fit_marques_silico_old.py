...
def run(layer: str="L1"):
    ...
    # get config
    # vivo
    data_conf, _ = get_config(
        "vivo_marques", "c26"
    ).values()
    PREP_PATH_h_vivo = data_conf["preprocessing"]["output"]["trace_file_path"]
    ...
    MISSING_NOISE_PATH = data_conf["preprocessing"]["fitting"]["missing_noise_path"]
