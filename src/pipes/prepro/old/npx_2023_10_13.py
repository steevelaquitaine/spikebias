"""pipeline for data processing npx 2023_10_13 experiment

usage: 

    sbatch cluster/processing/process_npx_2023_10_13.sbatch

duration: takes 26 min on a compute node (spike and trace acquisition have same sampling frequencies) 
"""
...
SIMULATION_DATE = "2023_10_13"      # specifies the run (date)
data_conf, param_conf = get_config(EXPERIMENT, SIMULATION_DATE).values()

# Setup recording rescaling parameters
GAIN = 1e5
