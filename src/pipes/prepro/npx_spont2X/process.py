"""pipeline to process 2X-accelerated neuropixels spontaneous biophysical model
...
- 2X-accelerated
 ...
 usage:
    ...
    # sbatch cluster/prepro/marques_silico/process_40m_noise_ftd_gain_ftd_adj10perc_less.sbatch
    
    # 2. speed-up and preprocess
    sbatch cluster/prepro/npx_spont2X/process.sbatch
...
# SETUP PARAMETERS
cfg, param_conf = get_config("silico_neuropixels", "2X").values()
