...
SpikeInterface's Recording and Sorting Extractors
 ...
 usage:
    ...
    python3.9 -c "from src.pipes.prepro.npx_spont_discon.process import run; run(filtering='butterworth')"
...
# pipeline
from src.pipes.prepro.npx_spont_discon.supp import concat
...
def stack(data_conf, param_conf):
    ...
    takes 30 min
    """
    concat.run(data_conf, param_conf)
...
def run(filtering: str="wavelet"):
    ...
    if PREPROCESS: # NOTE THAT THIS WAS NOT DONE YET
