...
modified: 11.03.2024
 ...
 usage:
    ...
    sbatch cluster/prepro/marques_silico/process_40m_noise_99_perc_lower.sbatch
...
OFFSET = True
SCALE_AND_ADD_NOISE = "noise_99_perc_lower"
...
def wire_probe(Recording, save_metadata:bool, job_dict=job_dict):
    ...
    # get write path
    WRITE_PATH = data_conf["probe_wiring"]["40m"]["output_gain_fitd_noise_99_perc_lower"]
...
def preprocess_recording(job_dict: dict, filtering='butterworth'):
    ...
    """
    # write path
    WRITE_PATH = data_conf["preprocessing"]["output"]["40m"]["trace_file_path_gain_fitd_noise_99_perc_lower"]
    ...
    # preprocess
    Preprocessed = preprocess.run_butterworth_filtering_noise_99_perc_lower(data_conf,
                                  param_conf)
    # save
    shutil.rmtree(WRITE_PATH, ignore_errors=True)
