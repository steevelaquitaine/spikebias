...
modified: 11.03.2024
 ...
 usage:
    ...
    sbatch cluster/processing/marques_silico/process_40m_noise_none_gain_1e4.sbatch
...
def wire_probe(Recording, save_metadata:bool, job_dict=job_dict):
    ...
    # path
    WRITE_PATH = data_conf["probe_wiring"]["40m"]["output_noise_none_gain_1e4_int16"]
...
def preprocess_recording(Wired, job_dict: dict, filtering='butterworth', load_wired=False):
    ...
    # write path
    READ_PATH = data_conf["probe_wiring"]["40m"]["output_noise_none_gain_1e4_int16"]
    WRITE_PATH = data_conf["preprocessing"]["output"]["40m"]["trace_file_path_noise_none_gain_1e4_int16"]
