...
modified: 11.03.2024
 ...
 usage:
    ...
    sbatch cluster/processing/marques_silico/process_40m_noise_20_perc_lower.sbatch
...
OFFSET = False
SCALE_AND_ADD_NOISE = "noise_20_perc_lower"
...
def wire_probe(Recording, save_metadata:bool, job_dict=job_dict):
    ...
    # get write path
    WRITE_PATH = data_conf["probe_wiring"]["output_noise_20_perc_lower"]
...
def preprocess_recording(job_dict: dict, filtering='butterworth'):
    ...
    """
    # write path
    WRITE_PATH = data_conf["preprocessing"]["output"]["trace_file_path_noise_20_perc_lower"]
    ...
    # preprocess
    Preprocessed = preprocess.run_butterworth_filtering_noise_20_perc_lower(data_conf,
                                  param_conf)
    # save
    shutil.rmtree(WRITE_PATH, ignore_errors=True)
