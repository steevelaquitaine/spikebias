...
# SET PARAMETERS
params = {
    "subject_id": "vivo-horvath-depth-1",
    "session_description": "Probe-wired Horvath Recording at depth 1",
    "identifier": str(uuid.uuid4()),
    "session_start_time": datetime.now(tzlocal()),
    "experimenter": "Laquitaine Steeve",
    "lab": "Blue Brain Project",
    "institution": "EPFL",
    "experiment_description": "Probe-wired Horvath Recording at depth 1",
    "session_id": "001",
