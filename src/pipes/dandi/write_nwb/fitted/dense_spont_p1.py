...
Usage:  
    ...
    sbatch cluster/dandi/write_nwb/fitted/dense_spont_p1.sh
...
params = {
    ...
    "session_description": "Biophysical simulation of dense probe at depth 1 in the spontaneous regime. Background noise and gain are fitted to Horvath dataset.",
    "identifier": str(uuid.uuid4()),
    "session_start_time": datetime.now(tzlocal()),
    "experimenter": "Laquitaine Steeve",
    "lab": "Blue Brain Project",
    "institution": "EPFL",
    "experiment_description": "Biophysical simulation of dense probe at depth 1 in the spontaneous regime. Background noise and gain are fitted to Horvath dataset.",
    "session_id": "003",
