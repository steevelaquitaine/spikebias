...
# SETUP CONFIG
data_conf, param_conf = get_config("vivo_horvath", "probe_2").values()
REC_PATH = data_conf["probe_wiring"]["full"]["output"]
NWB_PATH = data_conf["probe_wiring_nwb"] # write path

# SET PARAMETERS
params = {
    "subject_id": "vivo-horvath-depth-2",
    "session_description": "Probe-wired Horvath Recording at depth 2",
    "identifier": str(uuid.uuid4()),
    "session_start_time": datetime.now(tzlocal()),
    "experimenter": "Laquitaine Steeve",
    "lab": "Blue Brain Project",
    "institution": "EPFL",
    "experiment_description": "Probe-wired Horvath Recording at depth 2",
    "session_id": "001",
