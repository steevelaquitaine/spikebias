...
Usage:
    ...
    sbatch cluster/dandi/write_nwb/raw/npx_evoked_40Hz.sh
...
# SET PARAMETERS
params = {
    "subject_id": "npx_evoked_sf_40Hz",
    "session_description": "Raw biophysical simulation in the evoked regime with a 40Hz sampling frequency",
    "identifier": str(uuid.uuid4()),
    "session_start_time": datetime.now(tzlocal()),
    "experimenter": "Laquitaine Steeve",
    "lab": "Blue Brain Project",
    "institution": "EPFL",
    "experiment_description": "Raw biophysical simulation in the evoked regime with a 40Hz sampling frequency",
    "session_id": "002",
...
def init_nwbfile(
    subject_id="001",
    session_description="Raw biophysical simulation in the spontaneous regime",
    identifier=str(uuid.uuid4()),
    session_start_time=datetime.now(tzlocal()),
