...
Usage: 
    ...
    sbatch cluster/dandi/write_nwb/raw/biophy_summed_reyes.sh
...
# SET PARAMETERS
params = {
    "subject_id": "biophy_summed_traces_reyes",
    "session_description": "Biophysical simulation of a recording with the Reyes probe for 40 secs in the spontaneous regime. All cell traces within the cortical column are summed.",
    "identifier": str(uuid.uuid4()),
    "session_start_time": datetime.now(tzlocal()),
    "experimenter": "Laquitaine Steeve",
    "lab": "Blue Brain Project",
    "institution": "EPFL",
    "experiment_description": "Biophysical simulation of a recording with the Reyes probe for 40 secs in the spontaneous regime. All cell traces within the cortical column are summed.",
    "session_id": "006",
...
def init_nwbfile(
    ...
    nwbfile = NWBFile(
        ...
        keywords=["Biophysical simulation", "Summed extracellular traces", "Reyes probe"]
    )
