...
Description: download NWB dataset for the dense probe at depth 3

Usage:  

    sh cluster/nwb/download/dense_spont_p3.sh
    ...
    python -m src.pipes.nwb.download.dense_spont_p3
