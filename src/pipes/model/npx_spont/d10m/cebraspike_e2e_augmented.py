...
# model save path
MODEL_PATH_40Khz_e2e_pooled_pm1 = "/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/analysis/sorting_quality/models/cebra/sf_40Khz/e2e_pooled_pm1"
MODEL_PATH_40Khz_e2e_pooled_pm1_qmetrics = "/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/analysis/sorting_quality/models/cebra/sf_40Khz/e2e_pooled_pm1_qmetrics"
...
qmetrics = get_quality_metrics(KS4_ne_10m, STUDY_ne, STUDY_ne_su, 384, load_if_exists)

# get entired dataset for layer and pooled models
dat1_40Khz = get_dataset_by_layer(
    KS4_ne_10m, GT_ne_10m, STUDY_ne_su, quality_path, "KS4", "E", 25, 3, 1
)
...
for seed_i in seed:
    ...
    model2_output = get_model2(
        model_cfg, TRAIN, MODEL_PATH_40Khz_e2e_pooled_pm1_qmetrics, train_data, MAX_ITER
    )
...
# save results
with open(
    MODEL_PATH_40Khz_e2e_pooled_pm1_qmetrics + "tr_ix_all.pickle", "wb"
) as handle:
    pickle.dump(tr_ix_all, handle, protocol=pickle.HIGHEST_PROTOCOL)
with open(
    MODEL_PATH_40Khz_e2e_pooled_pm1_qmetrics + "test_ix_all.pickle", "wb"
) as handle:
    pickle.dump(test_ix_all, handle, protocol=pickle.HIGHEST_PROTOCOL)
with open(
    MODEL_PATH_40Khz_e2e_pooled_pm1_qmetrics + "test_labels.pickle", "wb"
) as handle:
    pickle.dump(test_labels, handle, protocol=pickle.HIGHEST_PROTOCOL)
with open(
    MODEL_PATH_40Khz_e2e_pooled_pm1_qmetrics + "predictions_all.pickle", "wb"
) as handle:
    pickle.dump(predictions_all, handle, protocol=pickle.HIGHEST_PROTOCOL)
with open(
    MODEL_PATH_40Khz_e2e_pooled_pm1_qmetrics + "precision.pickle", "wb"
) as handle:
    pickle.dump(precision, handle, protocol=pickle.HIGHEST_PROTOCOL)
with open(MODEL_PATH_40Khz_e2e_pooled_pm1_qmetrics + "recall.pickle", "wb") as handle:
    pickle.dump(recall, handle, protocol=pickle.HIGHEST_PROTOCOL)
with open(MODEL_PATH_40Khz_e2e_pooled_pm1_qmetrics + "models.pickle", "wb") as handle:
...
# save figure
utils.savefig("figures/1_sorting_quality/cebraspike/assets/fig5H_npx_ks4_e2e_loss.svg")
...
# save figure
utils.savefig(
    "figures/1_sorting_quality/cebraspike/assets/fig5I_npx_ks4_e2e_test_embed.svg"
)
...
# # save figure
utils.savefig("figures/1_sorting_quality/cebraspike/assets/fig5J_npx_ks4_e2e_perf.svg")
...
# save figure
utils.savefig("figures/1_sorting_quality/cebraspike/assets/fig5K_npx_ks4_e2e_preds.svg")