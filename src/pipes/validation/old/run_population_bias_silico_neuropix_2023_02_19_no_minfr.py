...
The experiment's run is configured in conf/supp/silico_reyes/2023_01_13/).
...
First setup 
    ...
    spack env create kilosort2_silico_env spack_kilosort_silico.yaml
    ...
    python3 -m src.pipes.sorting.run_population_bias_silico_neuropix_2023_02_19

    # or run interactively in Jupyter notebook or ipython
    from src.pipes.sorting import run_population_bias_silico_neuropix_2023_02_19; fig = run_population_bias_silico_neuropix_2023_02_19.run()
...
# set kilosort 2
KILOSORT_2 = False  # fails due to matlab mkl version error
...
def run():
    ...
    if KILOSORT_3:
        sorting_KS3 = bias.sort_with_KS3_no_minfr(
            trace_recording,
            data_conf,
            LOAD_SORTING_KS3,
            minFR=MIN_FR,
    ...
    # write metadata
    metadata = {
        "fig_path": data_conf["figures"]["silico"][
            "population_bias_silico_no_minfr"
        ],
    ...
    write_metadata(
        metadata,
        data_conf["figures"]["silico"]["population_bias_silico_no_minfr"],
    )
    return fig
