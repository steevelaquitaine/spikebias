"""Computs power spectral densities of dense probe 3
...
Execution time: 1 mins

Tested on Ubuntu 24.04, 188 RAM, 32 cores
"""
...
# setup load paths
RAW_PATH = os.path.join(PROJ_PATH, "dataset/00_raw/recording_dense_probe3/")

# setup save paths
RAW_PSD_PATH = os.path.join(PROJ_PATH, "dataset/01_intermediate/psd_raw_dense_probe3.npy")
