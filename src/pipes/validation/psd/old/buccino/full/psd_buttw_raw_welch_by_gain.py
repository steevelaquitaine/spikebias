...
Usage:
    ...
    sbatch cluster/figures/main/buccino/psd/full/psd_buttw_raw_welch_by_gain.sbatch
...
WIRED_GAIN_2_INT16_PATH = data_conf_bucci["probe_wiring"]["10m"]["output_gain_2_int16"]
WIRED_FITD_INT16_PATH = data_conf_bucci["probe_wiring"]["10m"]["output_gain_fitd_int16"]
WIRED_HALF_FITD_INT16_PATH = data_conf_bucci["probe_wiring"]["10m"]["output_gain_half_fitd_int16"]
WIRED_4X_FITD_INT16_PATH = data_conf_bucci["probe_wiring"]["10m"]["output_gain_4x_fitd_int16"]
WIRED_6X_FITD_INT16_PATH = data_conf_bucci["probe_wiring"]["10m"]["output_gain_6x_fitd_int16"]
...
RawSili = spre.scale(RawSili, gain=2)
RawSili = spre.astype(RawSili, "int16")
RawSili.save(
    folder=WIRED_GAIN_2_INT16_PATH,
    format="binary",
    n_jobs=4,
    chunk_memory="40G",
    overwrite=True,
...
# get traces 
raw_traces_sili_gain_2 = RawSili.get_traces()
prep_traces_sili_gain_2 = PreSili.get_traces()
...
RawSili = si.load_extractor(RAW_PATH_bucci)
RawSili = RawSili.frame_slice(start_frame=0, end_frame=SFREQ_BUCCI * 10 * 60)
RawSili = spre.scale(RawSili, fitting_gain/2)
RawSili = spre.astype(RawSili, "int16")
RawSili.save(
    folder=WIRED_HALF_FITD_INT16_PATH,
    format="binary",
    n_jobs=4,
    chunk_memory="40G",
    overwrite=True,
...
# get traces
raw_traces_sili_half_ftd = RawSili.get_traces()
prep_traces_sili_half_ftd = PreSili.get_traces()
...
RawSili = si.load_extractor(RAW_PATH_bucci)
RawSili = RawSili.frame_slice(start_frame=0, end_frame=SFREQ_BUCCI * 10 * 60)
RawSili = spre.scale(RawSili, fitting_gain * 4)
RawSili = spre.astype(RawSili, "int16")
RawSili.save(
    folder=WIRED_4X_FITD_INT16_PATH,
    format="binary",
    n_jobs=4,
    chunk_memory="40G",
    overwrite=True,
...
# get traces
raw_traces_sili_4x_ftd = RawSili.get_traces()
prep_traces_sili_4x_ftd = PreSili.get_traces()
...
RawSili = spre.astype(RawSili, "int16")
RawSili.save(
    folder=WIRED_6X_FITD_INT16_PATH,
    format="binary",
    n_jobs=4,
    chunk_memory="40G",
    overwrite=True,
...
# get traces
raw_traces_sili_6x_ftd = RawSili.get_traces()
prep_traces_sili_6x_ftd = PreSili.get_traces()


# PSD *******************************************************

# gain 2
out_raw_sili_gain_2 = get_welch_psd_parallelized(raw_traces_sili_gain_2)
out_prep_sili_gain_2 = get_welch_psd_parallelized(prep_traces_sili_gain_2)
...
# applied half gain
out_raw_sili_half_ftd = get_welch_psd_parallelized(raw_traces_sili_half_ftd)
out_prep_sili_half_ftd = get_welch_psd_parallelized(prep_traces_sili_half_ftd)

# 4x gain
out_raw_sili_4x_ftd = get_welch_psd_parallelized(raw_traces_sili_4x_ftd)
out_prep_sili_4x_ftd = get_welch_psd_parallelized(prep_traces_sili_4x_ftd)

# 6x gain
out_raw_sili_6x_ftd = get_welch_psd_parallelized(raw_traces_sili_6x_ftd)
out_prep_sili_6x_ftd = get_welch_psd_parallelized(prep_traces_sili_6x_ftd)
...
# save PSD for gain=2
np.save(
    "/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/postprocessing/hybrid/buccino/realism/lfp/raw_power_welch_10m_gain_2",
    out_raw_sili_gain_2,
)
np.save(
    "/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/postprocessing/hybrid/buccino/realism/lfp/prep_buttw_power_welch_10m_gain_2",
    out_prep_sili_gain_2,
)

# save PSD for fitting gain
np.save(
    "/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/postprocessing/hybrid/buccino/realism/lfp/raw_power_welch_10m_gain_fitd",
    out_raw_sili_ftd,
)
np.save(
    "/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/postprocessing/hybrid/buccino/realism/lfp/prep_buttw_power_welch_10m_gain_fitd",
    out_prep_sili_ftd,
)

# save PSD for half fitting gain
np.save(
    "/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/postprocessing/hybrid/buccino/realism/lfp/raw_power_welch_10m_gain_half_fitd",
    out_raw_sili_half_ftd,
)
np.save(
    "/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/postprocessing/hybrid/buccino/realism/lfp/prep_buttw_power_welch_10m_gain_half_fitd",
    out_prep_sili_half_ftd,
)

# save PSD for 4x fitting gain
np.save(
    "/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/postprocessing/hybrid/buccino/realism/lfp/raw_power_welch_10m_gain_4x_fitd",
    out_raw_sili_4x_ftd,
)
np.save(
    "/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/postprocessing/hybrid/buccino/realism/lfp/prep_buttw_power_welch_10m_gain_4x_fitd",
    out_prep_sili_4x_ftd,
)

# save PSD for 6x fitting gain
np.save(
    "/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/postprocessing/hybrid/buccino/realism/lfp/raw_power_welch_10m_gain_6x_fitd",
    out_raw_sili_6x_ftd,
)
np.save(
    "/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/postprocessing/hybrid/buccino/realism/lfp/prep_buttw_power_welch_10m_gain_6x_fitd",
