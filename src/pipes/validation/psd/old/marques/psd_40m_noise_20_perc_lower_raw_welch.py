...
def save_traces_in_ctx(
    ...
    # vivo (1m)
    np.save(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/dataeng/1_vivo/marques/campaign/c26_fixed/traces_in_ctx_noise_20_perc_lower",
        raw_traces_vivo,
    )
    np.save(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/preprocessed/1_vivo/marques/campaign/c26_fixed/traces_in_ctx_noise_20_perc_lower",
        prep_traces_vivo,
    )

    # silico
    np.save(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/0_silico/neuropixels/concatenated_campaigns/dataeng/recording/traces_in_ctx_noise_20_perc_lower",
        raw_traces_sili,
    )

    np.save(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/0_silico/neuropixels/concatenated_campaigns/preprocessed/traces_in_ctx_noise_20_perc_lower",
        prep_traces_sili,
    )
...
def load_saved_traces_in_ctx():
    ...
    raw_traces_vivo = np.load(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/dataeng/1_vivo/marques/campaign/c26_fixed/traces_in_ctx_noise_20_perc_lower.npy"
    )
    prep_traces_vivo = np.load(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/preprocessed/1_vivo/marques/campaign/c26_fixed/traces_in_ctx_noise_20_perc_lower.npy"
    )

    # silico
    raw_traces_sili = np.load(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/0_silico/neuropixels/concatenated_campaigns/dataeng/recording/traces_in_ctx_noise_20_perc_lower.npy"
    )

    prep_traces_sili = np.load(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/0_silico/neuropixels/concatenated_campaigns/preprocessed/traces_in_ctx_noise_20_perc_lower.npy"
    )
...
def save_psd_results(out_raw_sili, out_prep_sili, out_raw_vivo, out_prep_vivo):
    ...
    # save sili
    np.save(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/0_silico/neuropixels/concatenated_campaigns/postpro/realism/lfp/full_raw_power_welch_noise_20_perc_lower",
        out_raw_sili,
    )

    np.save(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/0_silico/neuropixels/concatenated_campaigns/postpro/realism/lfp/full_prep_power_welch_noise_20_perc_lower",
        out_prep_sili,
    )

    # save vivo
    np.save(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/realism/1_vivo/marques/c26_fixed/postpro/full_raw_power_welch_noise_20_perc_lower.npy",
        out_raw_vivo,
    )

    np.save(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/realism/1_vivo/marques/c26_fixed/postpro/full_prep_power_welch_noise_20_perc_lower.npy",
        out_prep_vivo,
    )
...
def load_psd_results():
    ...
    out_raw_sili = np.load(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/0_silico/neuropixels/concatenated_campaigns/postpro/realism/lfp/full_raw_power_welch_noise_20_perc_lower.npy",
        allow_pickle=True,
    )
    out_raw_sili = out_raw_sili.item()

    out_prep_sili = np.load(
        "/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/0_silico/neuropixels/concatenated_campaigns/postpro/realism/lfp/full_prep_power_welch_noise_20_perc_lower.npy",
        allow_pickle=True,
    )
