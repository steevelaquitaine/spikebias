...
Usage:
    ...
    sbatch cluster/validation/psd/psd_welch_buttw_fitd_npx_10m.sbatch
...
raw_traces_nb = demean(RawNB.get_traces()) # all sites are L5
...
pre_traces_nb = demean(PreNB.get_traces()) # all sites are L5
