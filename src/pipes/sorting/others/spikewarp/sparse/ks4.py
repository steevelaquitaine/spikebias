...
usage:
    ...
    sbatch cluster/sorting/others/spikewarp/sparse/ks4.sh
...
duration:
    ...
    - total: 53 minutes with removing bad channels (sorting + postpro)
...
We need to remove bad channels, else not enough GPU memory
"""
import logging
