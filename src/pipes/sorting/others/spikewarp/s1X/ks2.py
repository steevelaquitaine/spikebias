...
usage:
    ...
    # Submit to cluster
    sbatch cluster/sorting/others/spikewarp/ks2.sh
...
sort_and_postprocess_10m(cfg, sorter, sorter_params, is_sort=True, is_postpro=True, extract_wvf=True, copy_binary_recording=True, remove_bad_channels=False)