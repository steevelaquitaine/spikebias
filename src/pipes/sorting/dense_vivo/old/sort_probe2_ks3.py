"""sort silico horvath probe 2 with Kilosort 3.0
takes 28 min
...
usage: 
    ...
    sbatch cluster/sorting/horvath_vivo/sort_probe2_ks3.sbatch
...
# SETUP CONFIG
data_conf, _ = get_config("vivo_horvath", "probe_2").values()
