...
3. Run the script with appropriate command-line arguments.
    ...
    nohup python -m src.pipes.sorting.test_params.driftcorr.dense_spont_probe1.10m.ks3 \
        --recording-path dataset/00_raw/recording_dense_probe1 \
            --preprocess-path dataset/01_intermediate/preprocessing/recording_dense_probe1 \
                --sorting-path-corrected ./temp/dense_spont_probe1/SortingKS3_10m_RTX5090_DriftCorr \
                    --sorting-output-path-corrected ./temp/dense_spont_probe1/KS3_output_10m_RTX5090_DriftCorr/ \
                        --study-path-corrected ./temp/dense_spont_probe1/study_ks3_10m_RTX5090_DriftCorr/ \
                            --sorting-path-not-corrected ./temp/dense_spont_probe1/SortingKS3_10m_RTX5090_NoDriftCorr \
                                --sorting-output-path-not-corrected ./temp/dense_spont_probe1/KS3_output_10m_RTX5090_NoDriftCorr/ \
                                    --study-path-not-corrected ./temp/dense_spont_probe1/study_ks3_10m_RTX5090_NoDriftCorr/
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--preprocess-path", default= './dataset/01_intermediate/preprocessing/recording_npx_evoked', help="preprocess recording path")
