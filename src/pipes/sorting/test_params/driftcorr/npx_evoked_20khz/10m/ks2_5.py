...
3. Run the script with appropriate command-line arguments.
    ...
    nohup python -m src.pipes.sorting.test_params.driftcorr.npx_evoked_20khz.10m.ks2_5 \
        --recording-path dataset/00_raw/recording_npx_evoked \
            --preprocess-path dataset/01_intermediate/preprocessing/recording_npx_evoked \
                --sorting-path-corrected ./temp/npx_evoked_20khz/SortingKS2_5_10m_RTX5090_DriftCorr \
                    --sorting-output-path-corrected ./temp/npx_evoked_20khz/KS2_5_output_10m_RTX5090_DriftCorr/ \
                        --study-path-corrected ./temp/npx_evoked_20khz/study_ks2_5_10m_RTX5090_DriftCorr/ \
                            --sorting-path-not-corrected ./temp/npx_evoked_20khz/SortingKS2_5_10m_RTX5090_NoDriftCorr \
                                --sorting-output-path-not-corrected ./temp/npx_evoked_20khz/KS2_5_output_10m_RTX5090_NoDriftCorr/ \
                                    --study-path-not-corrected ./temp/npx_evoked_20khz/study_ks2_5_10m_RTX5090_NoDriftCorr/
"""
