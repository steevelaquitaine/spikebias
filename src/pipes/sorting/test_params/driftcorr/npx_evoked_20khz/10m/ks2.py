...
1. Enable forward compatibility for CUDA libraries:
    ...
    cd dataset/01_intermediate/sorters/Kilosort-2.0.2_forwcomp/CUDA/
    matlab -batch mexGPUall
    ```
2. Activate `spikesort_rtx5090` environment.
3. Run the script with appropriate command-line arguments.

    nohup python -m src.pipes.sorting.test_params.driftcorr.npx_evoked_20khz.10m.ks2 \
        --recording-path dataset/00_raw/recording_npx_evoked \
            --preprocess-path dataset/01_intermediate/preprocessing/recording_npx_evoked \
                --sorting-path-corrected ./temp/npx_evoked_20khz/SortingKS2_10m_RTX5090_DriftCorr \
                    --sorting-output-path-corrected ./temp/npx_evoked_20khz/KS2_output_10m_RTX5090_DriftCorr/ \
                        --study-path-corrected ./temp/npx_evoked_20khz/study_ks2_10m_RTX5090_DriftCorr/ \
                            --sorting-path-not-corrected ./temp/npx_evoked_20khz/SortingKS2_10m_RTX5090_NoDriftCorr \
                                --sorting-output-path-not-corrected ./temp/npx_evoked_20khz/KS2_output_10m_RTX5090_NoDriftCorr/ \
                                    --study-path-not-corrected ./temp/npx_evoked_20khz/study_ks2_10m_RTX5090_NoDriftCorr/
"""
...
# sorting parameters
SORTER = "kilosort2"
SORTER_PATH = "/home/steeve/steeve/epfl/code/spikebias/dataset/01_intermediate/sorters/Kilosort-2.0.2_forwcomp/"
SORTER_PARAMS = {
        "detect_threshold": 6,
...
ss.Kilosort2Sorter.set_kilosort2_path(SORTER_PATH)
