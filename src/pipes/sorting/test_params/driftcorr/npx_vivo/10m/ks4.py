...
Usage: 
    ...
    3. Run the script with appropriate command-line arguments.
        ...
        nohup python -m src.pipes.sorting.test_params.driftcorr.npx_vivo.10m.ks4 \
            --recording-path dataset/00_raw/recording_marques_smith \
                --preprocess-path dataset/01_intermediate/preprocessing/recording_marques_smith \
                    --sorting-path-corrected ./temp/npx_vivo/SortingKS4_10m_RTX5090_DriftCorr \
                        --sorting-output-path-corrected ./temp/npx_vivo/KS4_output_10m_RTX5090_DriftCorr/ \
