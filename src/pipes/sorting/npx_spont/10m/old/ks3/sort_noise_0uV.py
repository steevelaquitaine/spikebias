"""sort 10 min of marques silico with Kilosort 3.0
takes 60 min (with saving, else 20 min), no noise, gain fitted to in vivo
...
usage:
    ...
    sbatch cluster/sorting/marques_silico/10m/buttw/ks3/sort_noise_0uV.sbatch
