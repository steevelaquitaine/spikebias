...
usage:
    ...
    sbatch cluster/sorting/marques_silico/10m/buttw/ks3/sort_noise_ftd_gain_ftd.sbatch
...
sorter_params = {
    ...
    "nfilt_factor": 4,
    "do_correction": True,
    "NT": 2*65792, # None, #16 * 1024 + 64, # #65792*3, # None: automatically computed, # 65792
...
KS3_SORTING_PATH = data_conf["sorting"]["sorters"]["kilosort3"]["10m"]["output_buttw_noise_ftd_gain_ftd"]
KS3_OUTPUT_PATH = data_conf["sorting"]["sorters"]["kilosort3"]["10m"]["ks3_output_buttw_noise_ftd_gain_ftd"]
