...
usage: 
    ...
    sbatch cluster/sorting/marques_silico/10m/wavelet/sort_ks3_wavlt_detth50.sbatch
...
# SET PARAMETERS
sorter_params = {
    "detect_threshold": 50, # 138,  # 12, # 6, # alters detection on a per spike basis and is applied to the voltage trace (default=6)
...
KS3_SORTING_PATH = '/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/sorting/0_silico/neuropixels_lfp_10m_384ch_hex0_40Khz_2023_10_18/be011315-9555-493e-a59c-27f42d1058ed/SortingKS3_wavlt_detth50/'
KS3_OUTPUT_PATH = '/gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/sorting/0_silico/neuropixels_lfp_10m_384ch_hex0_40Khz_2023_10_18/be011315-9555-493e-a59c-27f42d1058ed/KS3_output_wavlt_detth50/'
