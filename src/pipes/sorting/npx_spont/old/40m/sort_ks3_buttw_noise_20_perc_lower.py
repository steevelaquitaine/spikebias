...
# SET PATHS
# trace
WIRED_FLOAT32_PATH = data_conf["probe_wiring"]["output_noise_20_perc_lower"]
WIRED_INT16_PATH = data_conf["probe_wiring"]["output_noise_20_perc_lower_int16"]
# sorter
KS3_PACKAGE_PATH = data_conf["sorting"]["sorters"]["kilosort3"]["input_buttw"]
KS3_SORTING_PATH = data_conf["sorting"]["sorters"]["kilosort3"]["output_buttw_noise_20_perc_lower"]
KS3_OUTPUT_PATH = data_conf["sorting"]["sorters"]["kilosort3"]["ks3_output_buttw_noise_20_perc_lower"]
...
if SAVE_REC_INT16:
    ...
    WiredInt16 = spre.astype(WiredFloat32, "int16")
    WiredInt16.save(
