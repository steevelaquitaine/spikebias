...
usage:
    ...
    sbatch cluster/sorting/marques_silico/20m/sort_ks3_buttw_noise_0uV.sbatch
...
SECS = 20 * 60 # 20 minutes in seconds
...
KS3_SORTING_PATH = data_conf["sorting"]["sorters"]["kilosort3"]["20m"]["output_buttw_noise_0uV"]
KS3_OUTPUT_PATH = data_conf["sorting"]["sorters"]["kilosort3"]["20m"]["ks3_output_buttw_noise_0uV"]
...
logger.info("Done selecting 20 mins in: %s", round(time() - t0, 1))
