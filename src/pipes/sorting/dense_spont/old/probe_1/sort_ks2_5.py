"""sort horvath silico probe 1 with Kilosort 2.5
takes 28 min
...
usage: 
    ...
    # Submit to cluster
    sbatch cluster/sorting/horvath_silico/probe_1/sort_ks2_5.sbatch
"""
import logging
...
# SETUP CONFIG
data_conf, _ = get_config("silico_horvath", "concatenated/probe_1").values()
