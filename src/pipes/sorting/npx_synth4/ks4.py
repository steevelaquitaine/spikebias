...
Usage: 
    ...
    3. Run the script with appropriate command-line arguments.
        ...
        nohup python -m src.pipes.sorting.npx_synth4.ks4 \
            --recording-path dataset/00_raw/recording_buccino_s4 \
                --preprocess-path dataset/00_raw/recording_buccino_s4 \
                    --sorting-path-corrected ./temp/npx_synth4/SortingKS4_10m_RTX5090 \
                        --sorting-output-path-corrected ./temp/npx_synth4/KS4_output_10m_RTX5090/ \
                            --study-path-corrected ./temp/npx_synth4/study_ks4_10m_RTX5090/ \
                                --extract-waveforms \
                                    --remove-bad-channels \
                                        > out_ks4_synth_s4.log
"""
