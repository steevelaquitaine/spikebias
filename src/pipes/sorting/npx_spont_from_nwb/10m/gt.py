...
in a spontaneous regime, extracting waveforms into 
...
Usage:
    ...
    sbatch cluster/sorting/npx_spont_from_nwb/10m/gt.sh
    
    or 
    
    source /gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/preprint_2024/envs/spikinterf0_100_5/bin/activate
    python3.9 -m src.pipes.sorting.npx_spont_from_nwb.10m.gt
...
def postprocess_10m(cfg, duration_sec=600, create_full_study=False):
    ...
    Args:
        cfg (_type_): datasets path config
