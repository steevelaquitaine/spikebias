...
Usage:  
    ...
    sbatch cluster/nwb/export/dense_spont_p2.sh
...
params = {
    "subject_id": "004",
    "session_description": "Biophysical simulation of dense probe at depth 2 in the spontaneous regime",
    "identifier": str(uuid.uuid4()),
    "session_start_time": datetime.now(tzlocal()),
    "experimenter": "Steeve Laquitaine",
    "lab": "Blue Brain Project",
    "institution": "EPFL",
    "experiment_description": "Biophysical simulation of dense probe at depth 2",
    "session_id": "004",
