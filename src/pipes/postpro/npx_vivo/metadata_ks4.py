...
Usage:
    ...
    # on cluster
    sbatch cluster/postpro/npx_vivo/metadata_ks4.sbatch
...
from src.nodes.postpro.marques_vivo import get_waveforms
...
if __name__ == "__main__":
    """
    Usage:
        python3.9 ./save_metadata.py vivo_marques c26
    """
    ...
    argv = sys.argv[1:]
    EXPERIMENT = argv[0]    # e.g., "vivo_marques"
    RUN = argv[1]           # e.g., "c26"
