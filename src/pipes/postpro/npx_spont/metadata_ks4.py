...
Usage:
    ...
    # on cluster
    sbatch cluster/postpro/npx_spont/metadata_ks4.sh
...
from src.nodes.postpro import biases, get_waveforms, layer, firing_rate, cell_type, accuracy
...
if __name__ == "__main__":
    """
    Usage:
        python3.9 ./save_metadata.py silico_neuropixels concatenated
    """
    ...
    Sorting = firing_rate.label_firing_rates(Sorting, RECORDING_PATH, SORTING_PATH, save=False)
    ...
    SortingTrue = firing_rate.label_firing_rates(SortingTrue, RECORDING_PATH, GT_SORTING_PATH, save=False)
