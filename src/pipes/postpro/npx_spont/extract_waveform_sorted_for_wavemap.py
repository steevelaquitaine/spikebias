"""pipeline to compute Waveform Extractor for in silico simulation of Marques-Smith et al.
...
Usage:
    ...
    sbatch cluster/postpro/marques_silico/extract_waveform_sorted_for_wavemap.sbatch
