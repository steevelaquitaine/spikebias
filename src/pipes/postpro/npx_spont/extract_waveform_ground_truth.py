"""pipeline to compute ground truth Waveform Extractor for in silico simulation of Marques-Smith et al.
...
Usage:
    ...
    sbatch cluster/postpro/marques_silico/extract_waveform_ground_truth.sbatch
...
def run():
    ...
    # track time
    t0 = time()
    logger.info(f"Starting extracting Waveform for in silico Marques ...")

    # get Sorting extractor
    Sorting = si.load_extractor(GROUND_TRUTH_PATH)
