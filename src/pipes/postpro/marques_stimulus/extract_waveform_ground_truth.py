"""pipeline to compute ground truth Waveform Extractor for Marques stimulus
...
Usage:
    ...
    sbatch cluster/postpro/marques_stimulus/extract_waveform_ground_truth.sbatch
...
def run():
    ...
    # track time
    t0 = time()
    logger.info(f"Starting extracting Waveform for Marques Stimulus ...")
