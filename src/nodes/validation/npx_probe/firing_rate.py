...
def plot_single_unit_ratio_pros_of_added_details(ax, exp1, exp2, exp3, exp4, exp5, exp6, exp7,
    ...
    df[exp_names[2]] = (
        np.array([n_su_3, n_mu_3]) / exp3.shape[0]
    )    
    df[exp_names[3]] = (
        np.array([n_su_4, n_mu_4]) / exp4.shape[0]
    )    
    df[exp_names[4]] = (
        np.array([n_su_5, n_mu_5]) / exp5.shape[0]
    )        
    df[exp_names[5]] = (
    ...
    ax.annotate(
        f"""{n_mu_4}""",
        (number_pos['exp4_x'], number_pos['exp4_y_mu']),
        ha="center",
        color="w",
        rotation=0,
    )
    ax.annotate(
        f"""{n_su_4}""",
        (number_pos['exp4_x'], number_pos['exp4_y_su']),
        ha="center",
        color="k",
        rotation=0,
    )    
    ...
    ax.annotate(
        f"""{n_mu_5}""",
        (number_pos['exp5_x'], number_pos['exp5_y_mu']),
        ha="center",
        color="w",
        rotation=0,
    )
    ax.annotate(
        f"""{n_su_5}""",
        (number_pos['exp5_x'], number_pos['exp5_y_su']),
        ha="center",
        color="k",
        rotation=0,
    )    
    ...
    ax.annotate(
        f"""{n_mu_6}""",
        (number_pos['exp6_x'], number_pos['exp6_y_mu']),
        ha="center",
        color="w",
        rotation=0,
    )
    ax.annotate(
        f"""{n_su_6}""",
        (number_pos['exp6_x'], number_pos['exp6_y_su']),
        ha="center",
        color="k",
        rotation=0,
    )    
