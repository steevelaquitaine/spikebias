...
def add_spike_amplitude_extension(we, n_sites, load_if_exists: bool, job_kwargs:dict):
    ...
    if not load_if_exists:
        _ = si.postprocessing.compute_spike_amplitudes(we, outputs="by_unit", **job_kwargs)
    else:
