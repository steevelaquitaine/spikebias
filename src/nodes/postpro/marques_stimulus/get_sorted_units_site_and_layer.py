"""Pipeline to get in Marques stimulus sorted units' metadata (takes 5 min)
author: steeve.laquitaine@epfl.ch

Usage:
    sbatch cluster/postpro/marques_stimulus/get_sorted_units_site_and_layer.sbatch

Returns:
    csv: write a .csv metadata file for depth files 1,2,3

Prerequisites:
    Marques Stimulus recordings have been sorted, a SortingExtractors and WaveformExtractors exist
"""
