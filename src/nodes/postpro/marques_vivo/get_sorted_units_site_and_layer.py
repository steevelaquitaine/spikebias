"""Pipeline to get in vivo Marques sorted units' metadata (takes 5 min)
author: steeve.laquitaine@epfl.ch

Usage:
    sbatch cluster/postpro/marques_vivo/get_sorted_units_metadata.sbatch

Returns:
    csv: write a .csv metadata file for depth files 1,2,3

Prerequisites:
    Vivo marques recordings have been sorted, a SortingExtractors and WaveformExtractors exist
