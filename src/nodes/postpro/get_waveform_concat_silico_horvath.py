"""pipeline to extract spike waveforms from concatenated silico horvath probe 1, for near-contact cells
...
Usage:
    ...
    # submit to cluster
    sbatch cluster/postpro/get_waveform_concat_silico_horvath_1.sbatch
"""
# SETUP PACKAGES
import os
import logging
