...
from src.nodes.dataeng.lfp_only import campaign_stacking
...
def run(dataset_conf: dict, param_conf: dict, blue_config: dict):
    """stack all chunks into one campaign file

    Args:
        dataset_conf (dict): _description_
    """
    campaign_stacking.run(dataset_conf, param_conf, blue_config)
...
if __name__ == "__main__":
    ...
    # run
    run(data_conf, param_conf, campaign_params["blue_config"])
