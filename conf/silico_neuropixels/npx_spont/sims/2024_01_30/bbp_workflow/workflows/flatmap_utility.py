"""
Supersample flatmap positions to get subpixel resolution by M. Reimann
Copied from: https://bbpgitlab.epfl.ch/conn/structural/validation/wm-connectivity-validation/
"""
...
def colored_points_to_image(flat_coords, cols, extent=None):
    """Copied from `wm_recipe.py` to be able to run `flatmap_pixel_gradient()` below"""
