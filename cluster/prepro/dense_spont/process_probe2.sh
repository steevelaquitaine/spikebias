...
#!/bin/bash -l
#SBATCH -J prep-dense-spont2                              # job name
...
# run pipeline
srun -n 1 python3.9 -c "from src.pipes.prepro.dense_spont.process import run; run(experiment='dense_spont', run='probe_2', noise_tuning=4.3)"