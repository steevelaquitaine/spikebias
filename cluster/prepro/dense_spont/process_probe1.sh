...
## usage:
##      
##      sbatch cluster/prepro/dense_spont/process_probe1.sh
##
...
#!/bin/bash -l
#SBATCH -J prep-dense-spont1                              # job name
...
# run pipeline
srun -n 1 python3.9 -c "from src.pipes.prepro.dense_spont.process import run; run(experiment='dense_spont', run='probe_1', noise_tuning=1)"