...
#!/bin/bash -l
#SBATCH -J prep-dense-spont3-nwb                         # job name
...
# run pipeline
srun -n 1 python3.9 -c "from src.pipes.prepro.dense_spont.process_nwb import run; run(experiment='dense_spont', run='probe_3', noise_tuning=2)"