...
## usage:
##
##      sbatch cluster/prepro/npx_spont_discon/process.sh
##
...
#!/bin/bash -l
#SBATCH -J prep-npx_spont_discon                         # job name
...
#SBATCH -o ./cluster/logs/cluster/output/prepro/npx_spont_discon/%x_id_%A.out   # set log output file path
#SBATCH -e ./cluster/logs/cluster/output/prepro/npx_spont_discon/%x_id_%A.err   # set log error file path
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=laquitainesteeve@gmail.com

# 1. first follow the installation instructions in envs/spikinterf0_100_5.txt
module purge 
module load spack
