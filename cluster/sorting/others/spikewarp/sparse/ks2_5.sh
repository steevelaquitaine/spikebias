...
## usage:
##
##       sbatch cluster/sorting/others/spikewarp/sparse/ks2_5.sh
##
## stats: 21 mins
##
...
#!/bin/bash -l
#SBATCH -J ks25-spikewarp-sparse-10m                           # job name
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.others.spikewarp.sparse.ks2_5