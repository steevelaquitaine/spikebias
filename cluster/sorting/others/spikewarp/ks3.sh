...
#!/bin/bash -l
#SBATCH -J ks3-spikewarp-10m                           # job name
...
cd /gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/sorters/Kilosort3/CUDA
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.others.spikewarp.ks3