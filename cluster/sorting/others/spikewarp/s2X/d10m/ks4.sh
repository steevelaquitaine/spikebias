...
## usage:
##
##      sbatch cluster/sorting/others/spikewarp/s2X/d10m/ks4.sh
##
## stats: 21 mins
...
#!/bin/bash -l
#SBATCH -J ks4-spikewarp2X-10m                           # job name
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.others.spikewarp.s2X.d10m.ks4