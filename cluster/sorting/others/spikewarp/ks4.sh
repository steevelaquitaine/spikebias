...
## usage:
##
##      sbatch cluster/sorting/others/spikewarp/ks4.sh
##
## stats: 21 mins
...
#!/bin/bash -l
#SBATCH -J ks4-spikewarp-10m                           # job name
...
#SBATCH -o ./cluster/logs/cluster/output/spikewarp/sorting/slurm_nm_%x_id_%A.out   # set log output file path
#SBATCH -e ./cluster/logs/cluster/output/spikewarp/sorting/slurm_nm_%x_id_%A.err   # set log error file path
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.others.spikewarp.ks4