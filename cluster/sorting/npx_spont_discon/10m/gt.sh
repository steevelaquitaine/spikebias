...
## usage:
##
##      sbatch cluster/sorting/npx_spont_discon/10m/gt.sh
##
## stats: 21 mins
...
#!/bin/bash -l
#SBATCH -J gt-spont-disc-gt-10m                                 # job name
...
#SBATCH -o ./cluster/logs/cluster/output/sorting/npx_spont_discon/slurm_nm_%x_id_%A.out   # set log output file path
#SBATCH -e ./cluster/logs/cluster/output/sorting/npx_spont_discon/slurm_nm_%x_id_%A.err   # set log error file path
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.npx_spont_discon.10m.gt