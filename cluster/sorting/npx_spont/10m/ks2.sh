...
cd /gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/preprint_2024/sorters/Kilosort-2.0/CUDA
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.npx_spont.10m.ks2