...
## usage:
##
##      sbatch cluster/sorting/dense_vivo/probe_1/10m/ks3.sh
##
## stats: ??
...
#!/bin/bash -l
#SBATCH -J ks3-dense-vivo-probe1-10m                   # name
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.dense_vivo.probe_1.10m.ks3