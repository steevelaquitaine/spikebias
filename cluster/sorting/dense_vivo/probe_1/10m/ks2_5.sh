...
## usage:
##
##      sbatch cluster/sorting/dense_vivo/probe_1/10m/ks2_5.sh
##
## stats: ??
...
#!/bin/bash -l
#SBATCH -J ks2_5-dense-vivo-probe1-10m                   # name
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.dense_vivo.probe_1.10m.ks2_5