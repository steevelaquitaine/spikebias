...
## usage:
##
##      sbatch cluster/sorting/dense_vivo/probe_1/10m/ks4.sh
##
## stats: 21 mins
...
#!/bin/bash -l
#SBATCH -J ks4-dense-vivo-probe1-10m                     # job name
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.dense_vivo.probe_1.10m.ks4