...
## usage:
##
##      sbatch cluster/sorting/npx_evoked_from_nwb/10m/gt.sh
##
## stats: 21 mins
...
#!/bin/bash -l
#SBATCH -J gt-evoked-10m-nwb                                 # job name
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.npx_evoked_from_nwb.10m.gt