...
#!/bin/bash -l
#SBATCH -J ks2-dense-bioph-probe1-10m                     # name
...
cd /gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/preprint_2024/sorters/Kilosort-2.0.2/CUDA # last version patched
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.dense_bioph.probe_1.10m.ks2