...
#!/bin/bash -l
#SBATCH -J ks3-npx-evoked-10m                            # name
...
#SBATCH -o ./cluster/logs/cluster/output/npx_evoked/sorting/10m/slurm_nm_%x_id_%A.out   # set log output file path
#SBATCH -e ./cluster/logs/cluster/output/npx_evoked/sorting/10m/slurm_nm_%x_id_%A.err   # set log error file path
...
cd /gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/4_preprint_2023/sorters/Kilosort3_buttw/CUDA
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.npx_evoked.10m.ks3