...
## usage:
##
##      sbatch cluster/sorting/npx_evoked_40Khz/10m/ks.sh
##
## stats: 21 mins
...
#!/bin/bash -l
#SBATCH -J ks-npx-evoked-10m                             # name
...
cd /gpfs/bbp.cscs.ch/project/proj85/scratch/laquitai/preprint_2024/sorters/KiloSort/CUDA
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.npx_evoked_40Khz.10m.ks
