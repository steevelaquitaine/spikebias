...
## usage:
##
##      sbatch cluster/sorting/npx_evoked_40Khz/10m/ks4.sh
##
## stats: 21 mins

## Setup job config (one 16 GB GPU)

#!/bin/bash -l
#SBATCH -J ks4-npx-evoked-10m                            # job name
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.npx_evoked_40Khz.10m.ks4