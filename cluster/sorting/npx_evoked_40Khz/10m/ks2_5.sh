...
## usage:
##
##      sbatch cluster/sorting/npx_evoked_40Khz/10m/ks2_5.sh
##
## stats: 21 mins
...
#!/bin/bash -l
#SBATCH -J ks2_5-npx-evoked-10m                          # name
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.sorting.npx_evoked_40Khz.10m.ks2_5