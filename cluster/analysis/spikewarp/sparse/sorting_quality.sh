...
#!/bin/bash -l
#SBATCH -J spikewarp-sparse-quality                      # job name
...
#SBATCH -o ./cluster/logs/cluster/output/spikewarp/quality/sparse/%x_id_%A.out   # set log output file path
#SBATCH -e ./cluster/logs/cluster/output/spikewarp/quality/sparse/%x_id_%A.err   # set log error file path
...
srun python3.9 -m src.pipes.spikewarp.analysis.sparse.sorting_quality