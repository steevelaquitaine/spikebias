...
## Usage:
##
##      sbatch cluster/analysis/npx_evoked/full/code/by_sorter_and_q/igeom0.sh
##
## Takes 12 minutes
##
## config
...
#!/bin/bash -l
#SBATCH -J npx-igeom-by-sq-0                             # job name
...
srun python3.9 -m src.pipes.analysis.npx_evoked.full.code.by_sorter_and_q.igeom0