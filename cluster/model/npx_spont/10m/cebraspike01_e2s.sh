...
## usage:
##
##      sbatch cluster/model/npx_spont/10m/cebraspike01.sh
##
## duration: 20 min
...
srun -n 1 python3.9 -c "from src.pipes.model.npx_spont.d10m.cebraspike01 import run; run()"