...
python3.9 -m venv /gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/envs/cebraspike2 # create env
source /gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/envs/cebraspike2/bin/activate
/gpfs/bbp.cscs.ch/project/proj85/laquitai/spikebias_paper/envs/cebraspike/bin/python3.9 -m pip install -r /gpfs/bbp.cscs.ch/project/proj85/home/laquitai/spikebias/envs/cebraspike.txt
