...
#!/bin/bash -l
#SBATCH -J prep-npx_spont_discon-stack-sim                                # job name
...
#SBATCH -o ./cluster/logs/cluster/output/dataeng/npx_spont_discon/stack_sim/%x_id_%A.out   # set log output file path
#SBATCH -e ./cluster/logs/cluster/output/dataeng/npx_spont_discon/stack_sim/%x_id_%A.err   # set log error file path
...
# run pipeline
srun -n 1 python3.9 -c "from src.pipes.dataeng.npx_spont_discon.stack_sims import run; run()"