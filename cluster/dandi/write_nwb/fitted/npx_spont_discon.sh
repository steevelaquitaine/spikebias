...
## usage:
##
##      sbatch cluster/dandi/write_nwb/fitted/npx_spont_discon.sh
##
## stats: 1h30
...
#!/bin/bash -l
#SBATCH -J dandi-fitted-npx_spont_discon                        # job name
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.dandi.write_nwb.fitted.npx_spont_discon