...
## usage:
##
##      sbatch cluster/dandi/write_nwb/fitted/vivo_horvath1.sh
##
## stats: 1h30
...
#!/bin/bash -l
#SBATCH -J dandi-fitted-vivo_horvath1                        # job name
...
#SBATCH -o ./cluster/logs/cluster/output/dandi/write_nwb/vivo_horvath1/%x_id_%A.out   # set log output file path
#SBATCH -e ./cluster/logs/cluster/output/dandi/write_nwb/vivo_horvath1/%x_id_%A.err   # set log error file path
...
# run pipeline
srun -n 1 python3.9 -m src.pipes.dandi.write_nwb.fitted.vivo_horvath1