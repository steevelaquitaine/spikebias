...
if __name__=='__main__':
    ...
    writeH5File(path_to_simconfig,path_to_segment_positions,'lfp_fullNeuropixels_twoVersions.h5',numNeuronsPerPositionFile,numPositionFilesPerFolder,conductivity,circuitSubvolume,None,None)
